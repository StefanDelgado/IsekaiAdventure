public class dialogues {
    ...
    static void goddess1(){
        ...
        delay(5);
        System.out.println(" Your eyes eventually adjusted, showing you the wispy form of Lysandra in front of you, confused and disoriented.");
        delay(3);
        System.out.println(" ");
        System.out.println(" ???:");
    ...
    static void goddess3(Player uPlayer) {
        ...
        delay(3);
        System.out.println(" Choose with gratitude for the chance at redemption, and ponder the diverging paths before you. You are the epic weaver of your own fate, Alex.");
        delay(5);
